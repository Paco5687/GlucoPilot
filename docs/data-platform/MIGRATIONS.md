...
| 21 | `provider_clinical_review_audit` | Adds owner-scoped review threads plus immutable provider/owner events with target, actor, time, prior/new state, Evidence Bundle identity, and accept/dispute history. |
